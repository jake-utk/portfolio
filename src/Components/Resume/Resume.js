			...
			<div className='resume parallax-resume'>
				<section>
					...
					<p>
						...
						dreams and ideas can be brought to life and shared with the widest
						of audiences. This mindset of a constant drive to improve and a
						proven ability to create, along with a history of success within a
						team environment as well as a tenacious approach to problem solving
						is what I am able to bring to your team. I'm a self-starter who
						always has to be doing something, and I'm passionate about the
						quality of my work.
					</p>
				</section>
				<section>
